...
final BuiltSet<GSortEnumType> _$gSortEnumTypeValues =
    BuiltSet<GSortEnumType>(const <GSortEnumType>[
  _$gSortEnumTypeASC,
  _$gSortEnumTypeDESC,
]);
...
class _$GOpenIddictResponseDtoInputSerializer
  ...
  GOpenIddictResponseDtoInput deserialize(
      Serializers serializers, Iterable<Object?> serialized,
      {FullType specifiedType = FullType.unspecified}) {
    final result = GOpenIddictResponseDtoInputBuilder();
...
class GAddDeviceInputBuilder
  ...
  GOpenIddictResponseDtoInputBuilder get request =>
      _$this._request ??= GOpenIddictResponseDtoInputBuilder();
...
class GAdminStoreBookDeleteInputBuilder
  ...
  _$GAdminStoreBookDeleteInput _build() {
    ...
    try {
      _$result = _$v ??
          _$GAdminStoreBookDeleteInput._(
            id: id.build(),
          );
    } catch (_) {
      late String _$failedField;
...
class GBooleanOperationFilterInputBuilder
  ...
  _$GBooleanOperationFilterInput _build() {
    final _$result = _$v ??
        _$GBooleanOperationFilterInput._(
          eq: eq,
          neq: neq,
        );
    replace(_$result);
...
class _$GOpenIddictResponseDtoInput extends GOpenIddictResponseDtoInput {
  ...
  factory _$GOpenIddictResponseDtoInput(
      ...
      (GOpenIddictResponseDtoInputBuilder()..update(updates))._build();
  ...
  GOpenIddictResponseDtoInputBuilder toBuilder() =>
      GOpenIddictResponseDtoInputBuilder()..replace(this);
